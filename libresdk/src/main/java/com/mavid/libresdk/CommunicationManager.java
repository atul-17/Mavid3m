package com.mavid.libresdk;

import android.net.Network;

import com.mavid.libresdk.TaskManager.Alexa.CompanionProvisioningInfo;
import com.mavid.libresdk.TaskManager.Communication.HttpMavidClient;
...
import com.mavid.libresdk.TaskManager.Communication.Packet.Encoder.MavidPacketEncoder;
...
class CommunicationManager {
    ...
    public void askRefreshToken(String ipAddress,CommandStatusListenerWithResponse commandStatusListenerWithResponse){
        sendAlexaCommandToDevice(ipAddress, MavidPacketEncoder.getPacket((byte) 0xAA,COMMAND_TYPE_REQUEST,SubCommands.ASK_ALEXA_REFRESH_TOKEN,""),commandStatusListenerWithResponse);
    }
    public void askRefreshTokenWithNetwork(String ipAddress, CommandStatusListenerWithResponse commandStatusListenerWithResponse, Network network){
        sendAlexaCommandToDeviceWithNetwork(ipAddress, MavidPacketEncoder.getPacket((byte) 0xAA,COMMAND_TYPE_REQUEST,SubCommands.ASK_ALEXA_REFRESH_TOKEN,""),
