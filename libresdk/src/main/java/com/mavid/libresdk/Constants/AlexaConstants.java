package com.mavid.libresdk.Constants;
...
public class AlexaConstants {
    ...
    public static final String SET_LOCALE_SUCCESS = "UPDATE_LOCALE_SUCCESS";
    public static final String SET_LOCALE_FAILURE = "UPDATE_LOCALE_FAILURE";
    ...
    public interface Languages {
        ...
        public static final String ITALY = "it-IT";
        public static final String FRENCH = "fr-FR";
        public static final  String HINDI = "hi-IN";

        public   static final String ENG_AUS = "en-AU";

    }

    public interface Login {
        public static final String PROVISION_INFO = "_PROVISION_INFO";
    }
}
