...
import com.mavid.libresdk.TaskManager.Discovery.MessageDecoder.DatagramDecoder;
...
//            if (mAddress != null) {
//                ipAddress = mAddress.getHostAddress();
//            }
//            LibreLogger.d(this,"suma in getMyIp by name and address inetaddress\n"+ipAddress);
//            //getMyIP();
//            return ipAddress;
//        }catch (Exception e){
...
//            LibreLogger.d(this,"suma in getMyIp by name and address inetaddress exception\n"+e);
//
//            throw wifiException;
//        }
//    }
