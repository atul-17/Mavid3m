...
//    var workingRemoteButtonsHashMap: HashMap<String, String> = HashMap()
                ...
                object : CommandStatusListenerWithResponse {
                    override fun response(messageInfo: MessageInfo?) {
                        ...
                        if (messageInfo != null) {
                            ...
                            Log.d(TAG, "ldapi#3_Response".plus(dataJsonObject).toString())
    ...
    fun showCustomAlertForACRemoteSelection(buttonName: String, onUserButtonSelection: OnUserButtonSelection) {
        runOnUiThread {
            val alert: Dialog = Dialog(this@IRAcRemoteSelectionActivity)
    ...
    fun gotoNextActivity(selectedAppliance: String) {
        ...
        val intent = Intent(this@IRAcRemoteSelectionActivity, IRAddRemoteVPActivity::class.java)
        var bundle = Bundle()
