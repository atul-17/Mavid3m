...
public class AlexaDialogs {
    ...
    public static void somethingWentWrong(Context context) {
        try {
            ...
            alert.setContentView(com.mavid.R.layout.custom_single_button_layout);

            alert.setCancelable(false);

            AppCompatTextView tv_alert_title = alert.findViewById(com.mavid.R.id.tv_alert_title);

            AppCompatTextView tv_alert_message = alert.findViewById(com.mavid.R.id.tv_alert_message);
